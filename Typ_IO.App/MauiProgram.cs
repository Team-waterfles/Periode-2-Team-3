...
namespace BasisJaar2
{
    public static class MauiProgram
    {
        ...
        {
            {
                var levelrepository = sp.GetRequiredService<IStandaardlevelRepository>();
                Standaardlevel[] levels = [
            ...
            {
                var levelrepository = sp.GetRequiredService<IOefenlevelRepository>();
                Oefenlevel[] levels = [
                ...
                List<Oefenlevel> levels_in_database = levelrepository.ListAsync().Result;
